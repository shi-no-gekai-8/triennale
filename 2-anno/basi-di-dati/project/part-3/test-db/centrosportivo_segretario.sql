...
CREATE TABLE `segretario` (
  ...
  CONSTRAINT `fk_codStruttura2` FOREIGN KEY (`PrenotazioneStruttura`) REFERENCES `struttura` (`CodiceStruttura`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `segretario` VALUES ('DLANTN63A01A294X','2647','Antonio','Dalia','Biennale','3278422383'),('DNNGRD81A18I483A','5648','Gerardo','Donnarumma','Tempo Indeterminato','3388716693'),('MRRNTN79S14E906P','1023','Antonio','Mirra','Quintennale',NULL),('MTRNDR68E15F839U','3214','Andrea','Amitrano','Quintennale',NULL);
