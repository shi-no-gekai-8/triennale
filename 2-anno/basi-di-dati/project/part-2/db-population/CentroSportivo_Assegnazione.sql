...
CREATE TABLE `Assegnazione` (
  ...
  CONSTRAINT `fk_codAttività4` FOREIGN KEY (`CodiceAttività`) REFERENCES `Corso` (`codiceAttività`),
  CONSTRAINT `fk_codFiscale2` FOREIGN KEY (`CodiceFiscale`) REFERENCES `Istruttore` (`CodiceFiscale`)
...
INSERT INTO `Assegnazione` VALUES ('DMRLCU00A13D615B','5432'),('ZPPRNT80A01A783T','6782'),('VTLLRD95T13F912F','7654'),('FRRMRT80A01C129S','8726'),('PCCLNS99S27A509Y','9012');
